<template>
    <div class="movie-search">
  		...
  		<form class="movie-search__form">
			<label for="searchquery" class="movie-search__form__label"><i class="fas fa-search"></i></label>
			<input type="text" v-model="query" class="movie-search__form__input" 
				name="searchquery" id="searchquery" placeholder="Search for your serie..." 
				autocomplete="off" @keyup="fetchSearchResults" @focusout="hideResults">
		</form>

		<div class="movie-search__grid" v-show="resultsActive && query != ''">
			<div v-if="searchResults.length > 0">
				<p class="movie-search__item" 
